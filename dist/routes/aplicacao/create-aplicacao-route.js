...
export async function createAplicacaoRoute(app) {
    app.post("/aplicacao", {
        schema: {
            tags: ["Aplicação"],
            ...
            body: z.object({
                ...
                senha: z
                    ...
                    .describe("A senha da aplicação, para ser usada postiormente na obtenção do token para a autenticação da API."),
                dados: z.object({
...
//# sourceMappingURL=create-aplicacao-route.js.map