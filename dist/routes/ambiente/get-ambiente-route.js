...
export function getAmbienteRoute(app) {
    app.get("/ambiente/:idAmbiente", {
        schema: {
            tags: ["Ambiente"],
            ...
            response: {
                200: z.object({
                    ...
                    apiKey: z
                        .string()
                        .describe("Chave de autenticação exclusiva do ambiente, usada para salvar dados dos pacientes e seus dados."),
                    urlWebhook: z
                        .string()
...
//# sourceMappingURL=get-ambiente-route.js.map