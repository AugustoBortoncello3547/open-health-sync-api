...
export function globalErrorHandlerHook(err, request, reply) {
    if (defineCustosErrorsHandler(err, request, reply))
        return;
    if (defineZodErrorsHandler(err, request, reply))
        return;
    if (defineFastifyErrorsHandler(err, request, reply))
        return;
...
function defineCustosErrorsHandler(err, request, reply) {
...
function defineZodErrorsHandler(err, request, reply) {
...
function defineFastifyErrorsHandler(err, request, reply) {
...
//# sourceMappingURL=global-error-handler-hook.js.map