...
export class CreateAplicacaoController {
    ...
    constructor(createAplicacaoRepository = new MongoCreateAplicacaoRepository(), getAplicacaoRepository = new MongoGetAplicacaoRepository()) {
        this.createAplicacaoRepository = createAplicacaoRepository;
        this.getAplicacaoRepository = getAplicacaoRepository;
    }
    async handle(createAplicacaoRequest) {
...
//# sourceMappingURL=create-aplicacao.js.map