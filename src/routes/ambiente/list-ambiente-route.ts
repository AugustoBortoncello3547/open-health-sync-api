...
import z from "zod";
import { ListAmbienteController } from "../../controllers/ambiente_bkp/list-ambiente/list-ambiente";
import type { ListAmbienteParams } from "../../controllers/ambiente_bkp/list-ambiente/types";
